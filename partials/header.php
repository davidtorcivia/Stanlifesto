...
<head>
	...
	<!-- IndieShare-->
	<script type="text/javascript" src="<?php echo theme_url('assets/js/indiesocial.min.js'); ?>"></script>
	<link rel="stylesheet" href="<?php echo theme_url('assets/css/fontello.css'); ?>" /><!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo theme_url('assets/css/fontello-ie7.css'); ?>"><![endif]-->
